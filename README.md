...
[![Java](https://img.shields.io/badge/Java-8-orange)](https://github.com/easy-4-java/pac4j-oauth-extension) [![License](https://img.shields.io/badge/license-Apache%202.0-green)](./LICENSE)
...
**pac4j-oauth-extension** extends pac4j's OAuth support (pac4j 4.5.7) with OAuth 2.0 clients for Chinese and Russian ecosystem providers:
...
[ Web Application ]
        |
        | pac4j-oauth-extension + pac4j-oauth/core
        v
+------------------------------------------+
...
<dependency>
    ...
    <artifactId>pac4j-oauth-extension</artifactId>
...
```groovy
implementation 'io.github.easy4j:pac4j-oauth-extension:1.0.x.20260630-SNAPSHOT'
```
