...
[![Java](https://img.shields.io/badge/Java-17-orange)](https://github.com/easy-4-java/pac4j-oauth-extension) [![License](https://img.shields.io/badge/license-Apache%202.0-green)](./LICENSE)
...
```groovy
implementation 'io.github.easy4j:pac4j-oauth-extension:2.0.x.20260630-SNAPSHOT'
```
...
| `feature/2.0.x` and `main` (this release line) | `2.0.x.*` | 17 | JDK 17 line |
